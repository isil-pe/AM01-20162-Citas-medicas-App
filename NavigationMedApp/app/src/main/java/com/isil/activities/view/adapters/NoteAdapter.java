...
public class NoteAdapter extends BaseAdapter implements Filterable {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(v == null)
        {
            ...
            holder.tviDoctor = (TextView) v.findViewById(R.id.tviDoctor);
            holder.tviEspec = (TextView) v.findViewById(R.id.tviEspec);
            v.setTag(holder);
        }
        ...
        if(entry != null)
        {
            ...
            holder.tviDoctor.setText(entry.getDoctor());
            holder.tviEspec.setText(entry.getEspec());
        }
